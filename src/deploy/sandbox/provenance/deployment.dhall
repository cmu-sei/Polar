...
let resolverOciSecret =  kubernetes.Secret::{
    , apiVersion = "v1"
    , kind = "Secret"
...
let provenanceDeployment = kubernetes.Deployment::{
    , metadata = kubernetes.ObjectMeta::{
...
in [ kubernetes.Resource.Secret resolverOciSecret , kubernetes.Resource.Deployment provenanceDeployment ]
