...
use std::fmt;
use jira_schema::jira::{self as schema};
use jira_schema::{CiJobArtifactID, DateTimeString};
use jira_schema::IdString;
use jira_schema::JobIdString;
use jira_schema::ContainerRepositoryID;
use jira_schema::BigInt;
...
#[derive(cynic::QueryFragment, Clone, Deserialize, Serialize, rkyv::Archive)]
#[cynic(schema = "jira", graphql_type = "Project")]
...
#[derive(cynic::QueryFragment, Clone, Deserialize, Serialize, rkyv::Archive)]
#[cynic(schema = "jira", graphql_type = "Query", variables = "SingleProjectQueryArguments")]
...
#[derive(cynic::QueryFragment, Deserialize, Serialize, rkyv::Archive, Clone)]
#[cynic(schema = "jira", graphql_type = "PipelineConnection")]
...
pub struct CiJobConnection {
    pub nodes: Option<Vec<Option<JiraCiJob>>>,
    pub page_info: PageInfo
}
...
#[derive(cynic::QueryFragment, Deserialize, Serialize, rkyv::Archive, Clone)]
#[cynic(schema = "jira", graphql_type = "Pipeline")]
...
#[derive(cynic::QueryFragment, Deserialize, Serialize, rkyv::Archive, Clone)]
#[cynic(schema = "jira", graphql_type = "CiJob")]
pub struct JiraCiJob {
...
/// See jira's graphql docs
#[derive(cynic::QueryFragment, Deserialize, Serialize, rkyv::Archive)]
#[cynic(schema = "jira", graphql_type = "ContainerRepositoryDetails")]
...
#[derive(cynic::QueryFragment, Deserialize, Serialize, rkyv::Archive)]
#[cynic(schema = "jira", graphql_type = "Query", variables = "ContainerRepositoryDetailsArgs")]
...
#[derive(cynic::QueryFragment, Deserialize, Serialize, rkyv::Archive)]
#[cynic(schema = "jira", graphql_type = "ContainerRepositoryConnection")]
