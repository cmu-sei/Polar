#!/usr/bin/env nu
# infra/targets/local-minimal/secrets.nu
#
# Creates Kubernetes secrets and ConfigMaps required by the minimal Polar
# profile: neo4j, cassini, cert-issuer, jaeger, jira, kube agents.
#
