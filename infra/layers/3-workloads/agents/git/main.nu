...
def main [context_nuon: string] {
    ...
    dhall-to-yaml --documents --quoted --file $tmp | save --force ($output_dir | path join "git-observer.yaml")
    rm $tmp
    ...
    dhall-to-yaml --documents --quoted --file $tmp | save --force ($output_dir | path join "git-consumer.yaml")
    rm $tmp
    ...
    dhall-to-yaml --documents --quoted --file $tmp | save --force ($output_dir | path join "git-scheduler.yaml")
    rm $tmp
