...
### jira
  > builds the jira agents and their images
  ~~~sh
  echo "Building jira agent images..."
  nix build .#polarPkgs.jiraAgent.observerImage -o jira-observer
  nix build .#polarPkgs.jiraAgent.consumerImage -o jira-consumer
  echo "loading images..."
  podman load < jira-observer
  podman load < jira-consumer
  ~~~
